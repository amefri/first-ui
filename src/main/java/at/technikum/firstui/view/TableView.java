...
public class TableView implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        double numColumns = 4.0;  // Total number of columns
        ...
        col2.setCellValueFactory(cellData -> new SimpleStringProperty("03.05.2024")); // Beispiel für statische Daten
        col3.setCellValueFactory(cellData -> new SimpleStringProperty("2h")); // Beispiel für statische Daten
        col4.setCellValueFactory(cellData -> new SimpleStringProperty("5km")); // Beispiel für statische Daten


        keepColumnsBoundTogether(numColumns, col1, tableView, col2, col3, col4);
    }

    static void keepColumnsBoundTogether(double numColumns, TableColumn<?, ?> col1, javafx.scene.control.TableView<?> tableView, TableColumn<?, ?> col2, TableColumn<?, ?> col3, TableColumn<?, ?> col4) {
